...
import { UnlockBillPayload } from '@alphabill/alphabill-js-sdk/lib/transaction/UnlockBillPayload.js';
...
const payload = new UnlockBillPayload(new UnlockBillAttributes(bill.getData().getBacklink()), bill.getUnitId(), {
